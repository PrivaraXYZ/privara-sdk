...
export class Withdrawals {
  ...
  async create(params: CreateWithdrawalParams, options?: RequestOptions): Promise<CreateWithdrawalResponse> {
  ...
  async list(params?: ListWithdrawalsParams, options?: RequestOptions): Promise<CursorPage<Withdrawal>> {
  ...
  async *listAutoPaginate(
    ...
    while (true) {
      const page = await this.list({ ...params, continuation_token: continuationToken }, options);
  ...
  async createBridgeChallenge(publicId: string, options?: RequestOptions): Promise<BridgeChallengeResponse> {
